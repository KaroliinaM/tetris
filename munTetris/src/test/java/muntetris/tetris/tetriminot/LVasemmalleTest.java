 ...
 * @author kape
 */
public class LVasemmalleTest {
    Tetrimino tetrimino;
    
    public LVasemmalleTest() {
    }
    ...
    //
    @Test
    public void LVasemmalleMuodostuu() {
    ...
    {
        assertEquals(2, this.tetrimino.alhaalla().getY());
    }
    @Test
